...
Java_com_music_player_PlayerController_createPlayer(
    JNIEnv *env,
    jobject thiz,
    jstring filePath
) {
...
Java_com_music_player_PlayerController_setupPlayer(
    JNIEnv *env,
    jobject thiz,
    jlong playerPtr,
    jstring filePath
...
// Play audio
JNIEXPORT void JNICALL
Java_com_music_player_PlayerController_play(
    JNIEnv *env,
    jobject thiz,
    jlong playerPtr
) {
...
// Pause audio
JNIEXPORT void JNICALL
Java_com_music_player_PlayerController_pause(
    JNIEnv *env,
    jobject thiz,
    jlong playerPtr
) {
...
// Stop audio
JNIEXPORT void JNICALL
Java_com_music_player_PlayerController_stop(
    JNIEnv *env,
    jobject thiz,
    jlong playerPtr
) {
...
// Set looping
JNIEXPORT void JNICALL
Java_com_music_player_PlayerController_setLoop(
    JNIEnv *env,
    jobject thiz,
    jlong playerPtr,
    jboolean loop
...
// Check if finished
JNIEXPORT jboolean JNICALL
Java_com_music_player_PlayerController_isFinished(
    JNIEnv *env,
    jobject thiz,
    jlong playerPtr
) {
...
JNIEXPORT jlong JNICALL
Java_com_music_player_PlayerController_getCurrentPosition(
    JNIEnv *env,
    jobject thiz,
    jlong playerPtr
) {
...
// Destroy player
JNIEXPORT void JNICALL
Java_com_music_player_PlayerController_destroyPlayer(
    JNIEnv *env,
    jobject thiz,
    jlong playerPtr
) {
